...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/libapparmor/libapparmor-2.8.2.ebuild,v 1.1 2013/12/03 17:30:19 kensington Exp $
...
inherit autotools-utils distutils-r1 perl-module versionator ${BZR_ECLASS}

DESCRIPTION="Library to support AppArmor userspace utilities"
HOMEPAGE="http://apparmor.net/"
if [[ ${PV} == 9999* ]] ; then
        KEYWORDS=""
        S=${WORKDIR}/${PN}-${PV}/libraries/${PN}
else
